...
### Etapa 3 — Resultado
O resultado pode ser visto na spool na `SYSTSPRT` do JOB e deverá ter uma sequência semelhante a essa quando executado com o número 4 no PARM (exibição de sequência de 4 números):
